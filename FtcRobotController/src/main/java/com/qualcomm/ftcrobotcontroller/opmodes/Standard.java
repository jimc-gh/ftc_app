...
//            cam = Camera.open(cameraId);
    ...
    public void startCamera() {
        ...
        if (preview == null) {
            ((FtcRobotControllerActivity) hardwareMap.appContext).STinitPreview(camera, this, previewCallback);
        }
    }
    ...
    public void stopCamera() {
        if (camera != null) {
            if (preview != null) {
                ((FtcRobotControllerActivity) hardwareMap.appContext).STremovePreview(this);
                preview = null;
            }
            camera.stopPreview();
